...
const ScanModal = ({isOpen, onOpen, onClose, cameraError, modalData} : any) => {
    ...
    return (
      <>
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          <ModalOverlay />
          <ModalContent>
            <ModalHeader>{cameraError ? "Camera Error"
...
export default function Scan(){
    ...
    return (
        <>
            ...
            >
                <Text textAlign={"center"} mb="3rem" fontSize={"1.8rem"} fontWeight={"bold"} color="#c28824">Scan Tiket Himalaya</Text>
                ...
                <Button mt="1.5rem" bgColor="blue" color="gold" onClick={() => {
                    router.push('/admin');
                }}>Kembali</Button>

            </Box>

            <ScanModal isOpen={isOpen} onOpen={onOpen} onClose={onClose} cameraError={cameraError} modalData={modalData}/>
        </>
    );
