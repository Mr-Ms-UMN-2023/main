...
model peserta_2023 {
  ...
  email_student           String   @db.VarChar(255)
  ...
  major                   String   @db.VarChar(255)
  year                    String   @db.VarChar(11)
  sub_gpa                 String   @db.VarChar(8)  
  gpa                     String   @db.VarChar(8)

  height                  String   @db.VarChar(11)
  weight                  String   @db.VarChar(11)
  clothes_size            String   @db.VarChar(11)
  shoe_size               Int  
  pants_size              String   @db.VarChar(11)
  ...
  picture                 String   @db.VarChar(255)
  personality_screenshot  String   @db.VarChar(255)
  grades_screenshot       String   @db.VarChar(255)
  student_card_screenshot String   @db.VarChar(255)
...
model sponsor_medpar{
  Sponsor_MedparID String @default(uuid()) @id 
  type Int 
