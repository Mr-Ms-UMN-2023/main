  ...
  return new Promise((resolve, reject) => {
    form.parse(req, async (err: any, fields: any, files: any) => {
      ...
      if (!instagram_username || instagram_username == "") {
        validationErrorList.push({
          errorType: "EMPTY_INSTAGRAM_USERNAME",
          message: "Username Instagram tidak boleh kosong.",
        });
      }
      ...
      if (!sub_gpa || sub_gpa == "") {
        validationErrorList.push({
          errorType: "EMPTY_SUB_GPA",
          message: "IPS tidak boleh kosong.",
        });
      }
      // - Check if GPA has other character other than numbers
      else if (!gpaPattern.test(sub_gpa)) {
        validationErrorList.push({
          errorType: "INVALID_SUB_GPA",
          message: "Format IPS tidak valid.",
        });
      }
      ...
      // - Check if height has other character other than numbers
        ...
        validationErrorList.push({
          ...
          message: "Format tinggi badan tidak valid.",
        });
      }
      ...
      // - Check if weight has other character other than numbers
        ...
        validationErrorList.push({
          errorType: "INVALID_WEIGHT",
          message: "Format berat badan tidak valid.",
        });
      }
      ...
      if (!clothes_size || clothes_size == "") {
        validationErrorList.push({
          errorType: "EMPTY_CLOTHES_SIZE",
          message: "Ukuran baju tidak boleh kosong.",
        });
      }
      ...
      if (!shoe_size || shoe_size == "") {
        validationErrorList.push({
          errorType: "EMPTY_SHOE_SIZE",
          message: "Ukuran sepatu tidak boleh kosong.",
        });
      }
      // - Check if shoe size has other character other than numbers
      else if (hasLetter.test(shoe_size)) {
        validationErrorList.push({
          errorType: "INVALID_SHOE_SIZE",
          message: "Format ukuran sepatu tidak valid.",
        });
      }
      ...
      if (!pants_size || pants_size == "") {
        validationErrorList.push({
          errorType: "EMPTY_PANTS_SIZE",
          message: "Ukuran celana tidak boleh kosong.",
        });
      }
      // - Check if pants size has other character other than numbers
      else if (hasLetter.test(pants_size)) {
        validationErrorList.push({
          errorType: "INVALID_PANTS_SIZE",
          message: "Format ukuran celana tidak valid.",
        });
      }
      ...
      if (!about_me || about_me == "") {
        validationErrorList.push({
          errorType: "EMPTY_ABOUT_ME",
          message: "Deskripsi diri tidak boleh kosong.",
        });
      }
      ...
      if (!motivation || motivation == "") {
        validationErrorList.push({
          errorType: "EMPTY_MOTIVATION",
          message: "Motivasi diri tidak boleh kosong.",
        });
      }
      ...
      if (!personality || personality == "") {
        validationErrorList.push({
          errorType: "EMPTY_PERSONALITY",
          message: "Kepribadian diri tidak boleh kosong.",
        });
      }
      ...
      if (!talents || talents == "") {
        validationErrorList.push({
          errorType: "EMPTY_TALENT",
          message: "Talenta diri tidak boleh kosong.",
        });
      }
      ...
      const validGPAScreenshotExtensions = [
        "jpg",
        "jpeg",
        "png",
        "webp",
      ...
      const validStudentCardFileExtensions = [
        "jpg",
        "jpeg",
        "png",
        "webp",
      ...
      // - Check extension
        ...
        if (!validImageExtensions.includes(pictureExtension)) {
          validationErrorList.push({
            errorType: "INVALID_PICTURE_EXTENSION",
            message:
              "Jenis file tidak sesuai (harus .jpg, .png, .webp, atau .gif)",
          });
        } else {
          // SUCCESS
          const pictureTargetDirectory = path.join(
            process.cwd(),
          ...
          const pictureNewPath = path.join(
            pictureTargetDirectory,
            picture.newFilename
          );
          filesys.renameSync(pictureOldPath, pictureNewPath);
          userData.picture = path.join(
            "/public/images/pictures",
            picture.newFilename
          );
        }
      ...
      if (!personalityScreenshot) {
        validationErrorList.push({
          errorType: "EMPTY_PERSONALITY_SCREENSHOT",
          message: "Foto tidak boleh kosong.",
        });
      }
      // - Check extension
      else {
        const personalityScreenshotExtension = personalityScreenshot.filepath
          .split(".")
          .pop();
        if (!validImageExtensions.includes(personalityScreenshotExtension)) {
          validationErrorList.push({
            errorType: "INVALID_PERSONALITY_SCREENSHOT_EXTENSION",
            message: "Jenis file tidak sesuai (harus .jpg, .png, atau .webp)",
          });
        } else {
          // SUCCESS
          const personalityScreenshotTargetDirectory = path.join(
            process.cwd(),
            "/public/images/personality_screenshots"
          );
          ...
          const personalityScreenshotNewPath = path.join(
            personalityScreenshotTargetDirectory,
            personalityScreenshot.newFilename
          );
          filesys.renameSync(
            personalityScreenshotOldPath,
            personalityScreenshotNewPath
          );
          userData.personality_screenshot = path.join(
            "/public/images/personality_screenshots",
            personalityScreenshot.newFilename
          );
        }
      ...
      if (!gradesScreenshot) {
        validationErrorList.push({
          errorType: "EMPTY_GRADES_SCREENSHOT",
          message: "Foto tidak boleh kosong.",
        });
      }
      // - Check extension
      else {
        const gradesScreenshotExtension = gradesScreenshot.filepath
          .split(".")
          .pop();
        if (!validGPAScreenshotExtensions.includes(gradesScreenshotExtension)) {
          validationErrorList.push({
            errorType: "INVALID_GRADES_SCREENSHOT_EXTENSION",
            message:
              "Jenis file tidak sesuai (harus .jpg, .png, .webp, atau .gif)",
          });
        } else {
          // SUCCESS
          const gradesScreenshotTargetDirectory = path.join(
            process.cwd(),
            "/public/images/grades_screenshots"
          );
          ...
          const gradesScreenshotNewPath = path.join(
            gradesScreenshotTargetDirectory,
            gradesScreenshot.newFilename
          );
          filesys.renameSync(gradesScreenshotOldPath, gradesScreenshotNewPath);
          userData.grades_screenshot = path.join(
            "/public/images/grades_screenshots",
            gradesScreenshot.newFilename
          );
        }
      ...
      if (!studentCardScreenshot) {
        validationErrorList.push({
          errorType: "EMPTY_STUDENT_CARD_SCREENSHOT",
          message: "Foto tidak boleh kosong.",
        });
      }
      // - Check extension
      else {
        const studentCardScreenshotExtension = studentCardScreenshot.filepath
          .split(".")
          .pop();
        if (
          !validStudentCardFileExtensions.includes(
            studentCardScreenshotExtension
          )
        ) {
          validationErrorList.push({
            errorType: "INVALID_STUDENT_CARD_SCREENSHOT_EXTENSION",
            message:
              "Jenis file tidak sesuai (harus .jpg, .png, .webp, atau .gif)",
          });
        } else {
          // SUCCESS
          const studentCardScreenshotTargetDirectory = path.join(
            process.cwd(),
          ...
          const studentCardScreenshotNewPath = path.join(
            studentCardScreenshotTargetDirectory,
            studentCardScreenshot.newFilename
          );
          filesys.renameSync(
            studentCardScreenshotOldPath,
            studentCardScreenshotNewPath
          );
          userData.student_card_screenshot = path.join(
            "/public/images/student_card_screenshots",
            studentCardScreenshot.newFilename
          );
        }
      ...
      if (true) {
        try {
          ...
          fs.unlink(
            path.join(process.cwd(), userData.grades_screenshot),
            (err: any) => {
              if (err) {
                return;
              }
          ...
          fs.unlink(
            path.join(process.cwd(), userData.personality_screenshot),
            (err: any) => {
              if (err) {
                return;
              }
          ...
          fs.unlink(
            path.join(process.cwd(), userData.student_card_screenshot),
            (err: any) => {
              if (err) {
                return;
              }
